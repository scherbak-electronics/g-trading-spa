<template>
    <Page>
        <div class="w-full h-full text-left">
            <h1 class="text-2xl mb-1 font-bold text-gray-600">{{ trans('global.pages.markets') }}</h1>
            ...
            <div class="w-full h-fit text-left pt-3">
                <Button @click="changeColors" :label="'Set Random Colors'"/>
                <Button @click="changeType" class="ml-4" :label="'Change Chart Type'"/>
                <Button @click="changeData" class="ml-4" :label="'Change Data'"/>
            </div>
        </div>
    </Page>
</template>
...
function generateSampleData(ohlc) {
    ...
    const numberOfPoints = ohlc ? 500 : 500;
